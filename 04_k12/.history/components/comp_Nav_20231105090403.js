...
<div class='px-3 py-3 lg:px-5 lg:pl-3'>
    <div class='flex items-center justify-between'>
      ...
      <button
        id='run'
        class="bg-capinGreen text-white font-bold py-2 px-4 rounded transition transform hover:scale-105 hover:shadow-xl hover:shadow-capinGreen opacity-75 hover:opacity-100"
        >
        Run
      </button>
      </div>
