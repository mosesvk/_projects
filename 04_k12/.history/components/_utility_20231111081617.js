...
const createDivChartandModal = (chartId, modalId, title, component) => {
    // Initialize arrays to keep track of child and modal components
  ...
  component.appendChild = chartComponent;
};
