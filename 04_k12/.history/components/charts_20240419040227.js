...
`;
  ...
  if (percentChange < 0 && document.getElementById(`${name}_percentageChange`).classList.contains('text-green-500')) {
  ...
  } else if (percentChange > 0 && document.getElementById(`${name}_percentageChange`).classList.contains('text-red-500')) {
    document.getElementById(`${name}_percentageChange`).classList.remove('text-green-500')
    document.getElementById(`${name}_percentageChange`).classList.remove('dark:text-green-400')
