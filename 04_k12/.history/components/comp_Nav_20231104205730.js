    ...
    <div class='flex items-center justify-between'>
      ...
      <div
        ...
        >
          ...
          <div
            id='options-list'
            class='absolute left-0 z-10 mt-2 w-full bg-white border shadow-lg rounded-lg invisible dark:border dark:border-gray-500 dark:shadow-[0 10px 15px -3px white, 0 4px 6px -4px white] border-gray-300 dark:bg-gray-800'
          ></div>
      </div>
      <div
