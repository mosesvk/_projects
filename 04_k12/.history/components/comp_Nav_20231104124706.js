...
const optionListRegion = document.getElementById('option-list-region');
...
// Call the function with the regions_array
addRegionsToOptionsSelectRegionDropdown(regions_array);
