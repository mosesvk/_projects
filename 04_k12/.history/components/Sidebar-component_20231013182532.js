      ...
      <div class='flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700'>
        <ul class='pb-2 space-y-2'>
          <li>
            ...
            <div id="tooltip-default" role="tooltip" class='absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-2 bg-gray-100 text-gray-800 rounded-lg p-2 text-sm opacity-0 group-hover:opacity-100 transition-opacity'>
              Tooltip Content
            </div>
          </li>
          <li>
