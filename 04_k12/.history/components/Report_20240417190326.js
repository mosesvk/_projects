...
if (name == 'personnelMandatoryDebtService_SalariesAndBenefits_Employees') console.log('personnelMandatoryDebtService_SalariesAndBenefits_Employees', {min, peerArray: peer[dataArray], type, fixedNum})
