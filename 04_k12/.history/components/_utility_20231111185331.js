...
const createDivChartandModal = (
  ...
  const percentChangeValue = calculateAveragePercentageChange(clientYearObject);
  ...
  // Add modal initialization code here (if needed)
  // For example, if Flowbite requires manual initialization:
  // flowbite.init();
