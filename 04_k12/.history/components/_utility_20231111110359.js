...
const createAndAppendComponent = (chartId, modalId, title, chartComponents, modalComponents) => {
  const { chartComponent, modalComponent } = createDivChartandModal(chartId, modalId, title, chartComponents, modalComponents);
  return { chartComponents: chartComponent, modalComponents: modalComponent };
};

const createChartFromParsedData = (parsedData) => {
  if (parsedData) {
    createChart('studentsMain_chart', parsedData.studentAverageEnrollment_Peer, parsedData.studentAverageEnrollment_Client);
