    ...
    <div class='flex items-center justify-between'>
      ...
      <div
        ...
        >
          ...
          <div
            id='options-list'
            class='absolute left-0 z-10 mt-2 w-full bg-white border shadow-2xl rounded-lg invisible dark:border-gray-600 border-gray-300 dark:bg-gray-800 dark:shadow-xl dark:shadow-white'
          ></div>
      </div>
      <div
