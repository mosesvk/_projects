...
const createAndAppendComponent = (chartId, modalId, title, chartComponents, modalComponents) => {
  ...
  const { chartComponents: chartComponent, modalComponents: modalComponent } = createDivChartandModal(chartId, modalId, title, chartComponents, modalComponents);

  console.log(chartComponent);
  return { chartComponents, modalComponents };
};
