...
const createDivChartandModal = (
  ...
  const modalComponent = (`
    <div
      id=${modalId}
      tabindex="-1" class="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:w-3/4 md:inset-0 h-full max-h-full flex" aria-modal="true" role="dialog"
    >
      <div class='relative p-4 w-full md:max-w-fit lg:max-w-4xl max-h-full'>
