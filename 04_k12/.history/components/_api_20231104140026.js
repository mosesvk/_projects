...
const addTableColumnsToReport = (tableHeader, years) => {
  ...
  // Insert new year columns at the beginning
  years.forEach((year) => {
    ...
    // Insert the new <th> element at the end of the header row
    tableHeaderRow.insertBefore(newTh, tableHeaderRow.lastElementChild);
  });
};
