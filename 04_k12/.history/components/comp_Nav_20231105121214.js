...
<div class='px-3 py-3 lg:px-5 lg:pl-3'>
    <div class='flex items-center justify-between'>
      ...
      <button
        id='run'
        class="bg-green-300 text-white font-bold py-2 px-4 rounded transition transform text-black hover:scale-105 hover:shadow-md hover:shadow-green-300 opacity-75 hover:opacity-100"
        >
        Run
      </button>
      </div>
