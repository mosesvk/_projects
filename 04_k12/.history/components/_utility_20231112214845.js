...
const createDivChartandModal = async (
  chartId,
  modalId,
  title,
  chartComponents,
  ...
  const chartComponent = await  createChartComponent(
...
const createChartComponent = async (title, percentChangeValue, chartId, modalId) => {
  // const component = ;

  return new Promise((resolve) => {
    // Add a small delay before resolving the promise
    setTimeout(() => {
      resolve(` <div class='p-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800'>
