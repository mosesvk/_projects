const displayEnrollmentComponent = () => {
  ...
  const studentsMain_chart = new ApexCharts(
    document.getElementById('studentsMain_chart'),
    getMainChartOptions()
  );

  console.log(studentsMain_chart.ctx);
  studentsMain_chart.render();

  // init again when toggling dark mode
  document.addEventListener('dark-mode', function () {
    studentsMain_chart.updateOptions(getMainChartOptions());
  });
