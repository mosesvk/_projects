        ...
        <ul class='pb-2 space-y-2'>
          ...
          <li>
            <button
              ...
              class='flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700 active:bg-gray-100'
            >
              <svg
