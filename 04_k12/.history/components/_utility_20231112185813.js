...
const appendModalsToBody = (modalComponents, modalId) => {
  ...
  const existingModals = document.querySelectorAll(`[tabindex="-1"]`);
  console.log(existingModalContainer)

  document.body.appendChild(modalComponents);

  
  // Trigger a reflow
  modalContainer.offsetWidth;
  
  // console.log(modalContainer.innerHTML); // Should log true
