...
const createDivChartandModal = (
  ...
  const modalComponent = createModalComponent(modalId, title, modalId);
...
document.body.addEventListener('click', (event) => {
  ...
  // Check if the clicked element has the data-modal-toggle attribute
  const modalToggle = target.getAttribute('data-modal-toggle');

  if (modalToggle) {
    // Toggle the modal based on the data-modal-toggle attribute
