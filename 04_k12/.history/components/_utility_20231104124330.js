...
const regions_array = [
  ["New England", "CT", "RI", "MA", "VT", "NH"],
  ["Mid-Atlantic", "VA", "WV", "MD", "DE", "NJ", "NY", "PA", "DC"],
  ["South", "AR", "LA", "AL", "TN", "KY", "GA", "FL", "SC", "NC", "MS"],
  ["Midwest", "WI", "IL", "IN", "MI", "OH", "IA", "MN"],
  ["Plains", "KS", "MO", "OK", "TX", "ND", "SD", "NE"],
  ["Mountain/Southwest", "ID", "MT", "WY", "CO", "UT", "NV", "AZ", "NM"],
  ["West Coast", "CA", "OR", "WA"]
];
