...
function showApiLoadingFunction(action, mode) {
  ...
  const loadingApiText = document.getElementById("loadinApiText");
  ...
  if (action === "close") {
    ...
    if (mode === "api") {
      loadingApiText.classList.add("hidden");
      loadingApiYears.classList.remove("hidden");
      ...
      loadingApiText.classList.remove("hidden");
