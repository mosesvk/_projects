...
const updateCfiValue = (cfiValue) => {
  ...
  console.log(getElementById(ids[0]));

  if (cfiValue < 1) {
    document.getElementById(ids[0]).classList.toggle(propClass);
  } else if (cfiValue < 3) {
    document.getElementById(ids[1]).classList.toggle(propClass);
  } else if (cfiValue < 5) {
    document.getElementById(ids[2]).classList.toggle(propClass);
  } else if (cfiValue < 7) {
    document.getElementById(ids[3]).classList.toggle(propClass);
  } else if (cfiValue < 9) {
    document.getElementById(ids[4]).classList.toggle(propClass);
  } else {
    document.getElementById(ids[5]).classList.toggle(propClass);
  }
