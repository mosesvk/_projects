...
const createChart = (
  ...
  if (chartIds.includes(chartId)) {
    ...
    // Assign the chart instance to a variable if needed
    if (chartId === 'cfiRatio_chart') {
      window.cfiRatio_chart = chart;
    } else if (chartId === 'cfi_primaryReserveRatio_chart') {
      window.cfi_primaryReserveRatio_chart = chart;
    } else if (chartId === 'cfi_netIncomeOperationsRatio_chart') {
      window.cfi_netIncomeOperationsRatio_chart = chart;
    } else if (chartId === 'cfi_returnOnNetAssets_chart') {
      window.cfi_returnOnNetAssets_chart = chart;
    } else if (chartId === 'cfi_viabilityRatio_chart') {
      window.cfi_viabilityRatio_chart = chart;
    }
  }
};
