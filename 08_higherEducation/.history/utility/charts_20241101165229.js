    ...
    chart: {
      ...
      events: {
        updated: function(chartContext, config) {
          ...
          if (config.series[4].data.length !== selectedYearsArray.length) {
            config.series.data[4].data = previousData // Update the previous data
            console.log('fixed', mainName, {currentData: config.series.data[4].data, prevData: previousData});
          }
        }
      }
    },
