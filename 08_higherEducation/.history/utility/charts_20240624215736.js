    ...
    series: [
      {
        data: [
          ...
          { x: "Unrestricted Gifts", y: [ScholarshipAndFinancialAidClient, unrestrictedGiftsClient] },
          { x: "Auxiliary & Other", y: [unrestrictedGiftsClient, auxiliaryAndOtherClient] },
          { x: "Restricted Gifts", y: [auxiliaryAndOtherClient, restrictedGiftsClient] },
          { x: "Compensation & Benefits", y: [restrictedGiftsClient, compensationAndBenefitsClient] },
          { x: "General Expense", y: [compensationAndBenefitsClient, generalExpenseClient] },
          {
            x: "Surplus/Deficit",
            y: [0, surplusDefecitClient],
            style: { color: surplusDefecitColor },
          },
        ],
      },
    ],
