const getMainChartOptions = (
  ...
  let annotationLineObj;

  if (leng == 1) {
    annotationLineObj = { width: "200%", offsetXLine: -140, offsetXText: -140 };
  } else if (leng == 2) {
    annotationLineObj = { width: "200%", offsetX: -140, offsetXText: -140 };
  } else if (leng == 3) {
    annotationLineObj = { width: "200%", offsetX: -140, offsetXText: -140 };
  }
      ...
      yaxis: [
        {
          ...
          strokeDashArray: 0,
          width: annotationLineObj.width,
          offsetX: annotationLineObj.offsetXLine,
          label: {
            text: "Benchmark",
            borderColor: "transparent",
            borderWidth: 0,
            position: "top",
            offsetX: annotationLineObj.offsetXText,
            style: {
