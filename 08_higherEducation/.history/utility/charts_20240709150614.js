...
const getFfaChartOptions = (data) => {
  ...
  const revenueSchoolServicesClient = Number(
    data["ffa_revenueScholarshipsAndFinancialAid_Client"][currentYear].value * -1
  );
  ...
  console.log({ salariesAndWagesClient, employeeBenefitsClient, addition: salariesAndWagesClient + employeeBenefitsClient });
