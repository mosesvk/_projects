...
// loading modal div for api
let totalTasksForPrintingBase64ToQb
let completedTasksForPrintingBase64ToQb
...
function showApiLoadingFunction(action, mode) {
  ...
  const numOfCompleted = document.getElementById("numOfCompleted");
  ...
  if (action === "close") {
    ...
    if (mode === "api") {
      ...
      `                
        Chart
        <svg class="mx-2 font-extrabold w-10 h-10 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
          <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 12H5m14 0-4 4m4-4-4-4"/>
        </svg>       
        Base64   
      `
      numOfCompleted.textContent = completedTasksForPrintingBase64ToQb;
      numTotal.textContent = totalTasksForPrintingBase64ToQb;
