...
const getCurrentRatioChartOptions = (data) => {
  ...
  tableHeaderClient.innerHTML = `<th scope="col" class="px-2 py-1 text-lg tracking-wide"></th>`;
  ...
  tableHeaderPeer.innerHTML = `<th scope="col" class="px-2 py-1 text-lg tracking-wide"></th>`;
