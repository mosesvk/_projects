...
const mainPrint = async () => {
  ...
  await getPngString("cfi_netIncomeOperationsRatio_chart", 16);
  await getPngString("cfi_netIncomeOperationsRatio_chart", 17);
  await getPngString("cfi_netIncomeOperationsRatio_chart", 18);
  await getPngString("cfi_netIncomeOperationsRatio_chart", 19);
