...
const getAtlChartOptions = data => {
  ...
  selectedYearsArray.forEach (year => {
    ...
    clientArray.push (clientValue); 

    peerValue =
      Math.round(getAverageOfArray(totalAssetsPeer[year])) /
      Math.round(getAverageOfArray(totalLiabilitiesPeer[year]))
    peerArray.push (peerValue); 
