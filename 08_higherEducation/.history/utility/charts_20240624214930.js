...
const getFfaChartOptions = (data) => {
  ...
  const surplusDefecitColor = surplusDefecitClient > 0 ? window.chartColors.green : window.chartColors.red;
  ...
  return {
    colors: [window.chartColors.yellow, window.chartColors.teal],
    series: [
      {
        data: [
          ...
          { x: "Surplus/Deficit", y: [9, 11], style: {color: surplusDefecitColor} },
        ],
      },
    ],
    chart: {
