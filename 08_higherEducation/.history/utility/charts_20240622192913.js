...
const getSoiClientChartOptions = (data) => {
  ...
  const auxiliaryValue = data['si_revenueAuxiliary_Client'][selectedYearsArray[0]].value
  const contributionsValue = data['si_revenueContributions_Client'][selectedYearsArray[0]].value
  const investmentsValue = data['si_revenueInvestments_Client'][selectedYearsArray[0]].value
