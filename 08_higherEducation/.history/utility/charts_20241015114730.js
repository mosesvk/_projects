...
selectedYearsArray.forEach((year, index) => {
  ...
  assetsRow.innerHTML += `
    <th scope="row" class="px-6 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
      ${totalAssetsArray[index] || '-'} <!-- Fallback in case data is missing -->
    </th>
  `;
  ...
  liabilitiesRow.innerHTML += `
    <th scope="row" class="px-6 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
      ${totalLiabilitiesArray[index] || '-'} <!-- Fallback in case data is missing -->
    </th>
  `;
  ...
  netPositionRow.innerHTML += `
    <th scope="row" class="px-6 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
      ${netPositionArray[index] || '-'} <!-- Fallback in case data is missing -->
    </th>
  `;
});
