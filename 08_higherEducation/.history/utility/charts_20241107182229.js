...
const getNetEducationalExpensePerStudentChartOptions = (data) => {
  ...
  selectedYearsArray.map((year) => {
    ...
    const peerAvg = data.ratio_Peer ? getAverageOfArray(data.ratio_Peer[year]) : 0
...
const getTuitionDependencyChartOptions = (data) => {
  ...
  selectedYearsArray.map((year) => {
    ...
    const ratioPeer = data.ratio_Peer ? Math.round(getAverageOfArray(data.ratio_Peer[year], 100)) : 0;
...
const getTuitionDiscountRateChartOptions = (data) => {
  ...
  selectedYearsArray.map((year) => {
    ...
    const ratioPeer = data.ratio_Peer ? Math.abs(
...
const getDebtBurdenRatioChartOptions = (data) => {
  ...
  selectedYearsArray.map((year) => {
    ...
    const peerRatioNum = data.ratio_Peer ? Math.abs(
...
const getEndowmentAssetsPerStudentChartOptions = (data) => {
  ...
  selectedYearsArray.map((year) => {
    ...
    const peerRatio = data.ratio_Peer ? Number(
