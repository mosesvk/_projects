...
const getAnualTraditionalNetTuitionPerStudentChartOptions = (data) => {
  ...
  const tableRowHeaderRow = document.getElementById("row_salariesBenefitsPerNetTuition_tableHeader");
  const salariesBenefitsPerNetTuitionRow = document.getElementById("row_salariesBenefitsPerNetTuition_main");
  const salariesBenefitsRow = document.getElementById("row_salariesBenefitsPerNetTuition_salariesBenefits");
  const netTuitionRevenueRow = document.getElementById("row_salariesBenefitsPerNetTuition_netTuitionRevenue");
