...
const getAnualTraditionalNetTuitionPerStudentChartOptions = (data) => {
  console.log({ name: "getAnualTraditionalNetTuitionPerStudentChartOptions()", data });
  
  const selectedYearsArray = getSelectedYearsFromLocalStorage();

  const tableHeaderRow = document.getElementById("row_annualTraditionalNetTuitionPerStudent_tableHeader");
  const annualTraditionalNetTuitionPerStudentRow = document.getElementById("row_annualTraditionalNetTuitionPerStudent_main");
  const netTuitionRevenueRow = document.getElementById("row_annualTraditionalNetTuitionPerStudent_netTuitionRevenue");
  const totalFullTimeStudentsRow = document.getElementById("row_annualTraditionalNetTuitionPerStudent_totalFullTimeStudents");
