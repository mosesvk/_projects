...
const getAdminCostsPerStudentChartOptions = (data) => {
  ...
  selectedYearsArray.map((year) => {
    const clientData = Number(data["adminCostsPerStudent_Client"][year].value);
    clientArray.push(clientData);

    const peerData = data["adminCostsPerStudent_Peer"][year];
    const peerAvg = getWeightedAverageOfArray(peerData, 'adminCostsPerStudent',year);
  ...
  console.log({ clientArray, peerAvgArray, peer25Array, peer50Array, peer75Array });
