...
const getSalariesAndBenefitsToTotalExpenseChartOptions = (data) => {
  ...
  const tableHeaderRow = document.getElementById("row_salariesBenefitsToTotalExpense_tableHeader");
  const salariesBenefitsToTotalExpenseRow = document.getElementById("row_salariesBenefitsToTotalExpense_main");
  const salariesAndBenefitsRow = document.getElementById("row_salariesBenefitsToTotalExpense_salariesBenefits");
  const totalExpensesRow = document.getElementById("row_salariesBenefitsToTotalExpense_totalExpenses");
...
const getSalariesAndBenefitsPerNetTuitionChartOptions = (data) => {
  ...
  const num =
    Number(data["salariesAndBenefitsPerNetTuition_Client"][mostRecentYear].value)
  ...
  // numbers for data table
  const tableHeaderRow = document.getElementById("row_salariesBenefitsPerNetTuition_tableHeader");
  const salariesBenefitsPerNetTuitionRow = document.getElementById("row_salariesBenefitsPerNetTuition_main");
  const salariesAndBenefitsRow = document.getElementById("row_salariesBenefitsPerNetTuition_salariesBenefits");
  const netTuitionRow = document.getElementById("row_salariesBenefitsPerNetTuition_netTuitionRevenue");
...
const getNetEducationalExpensePerStudentChartOptions = (data) => {
  ...
  const tableHeaderRow = document.getElementById("row_netEducationalExpensePerStudent_tableHeader");
  const netEducationalExpensePerStudentRow = document.getElementById("row_netEducationalExpensePerStudent_main");
  const netEducationalExpenseRow = document.getElementById("row_netEducationalExpensePerStudent_netEducationalExpense");
  const totalFullTimeStudentsRow = document.getElementById("row_netEducationalExpensePerStudent_totalFullTimeStudents");
  ...
  selectedYearsArray.map((year) => {
    peerAvgArray = [];
    peerAvgArray = getAverageOfArray(data["ratio_Peer"][year])

    const clientData =
      Number(data["ratio_Client"][year].value) * 100;
    clientArray.push(clientData);
    ...
    const netEducationalExpense = Number(data.netEducationalExpenses_Client[year].value);
