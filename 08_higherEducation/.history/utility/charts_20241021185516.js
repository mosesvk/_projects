...
const getEndowmentAssetsPerStudentChartOptions = (data) => {
  ...
  const peerRow = document.getElementById("row_endowmentAssetsPerStudent_peer");
  ...
  peerRow.innerHTML = `<th scope="col" class="px-6 py-2 text-xl text-gray-900 whitespace-nowrap dark:text-white">Peer</th>`;
