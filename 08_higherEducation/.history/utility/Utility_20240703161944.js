...
const updateCfiValue = (cfiValue) => {
  ...
  if (cfiValue < 1) {
    document.getElementById(ids[0]).classList.add(propClass);
  } else if (cfiValue < 3) {
    document.getElementById(ids[1]).classList.add(propClass);
  } else if (cfiValue < 5) {
    document.getElementById(ids[2]).classList.add(propClass);
  } else if (cfiValue < 7) {
    document.getElementById(ids[3]).classList.add(propClass);
  } else if (cfiValue < 9) {
    document.getElementById(ids[4]).classList.add(propClass);
  } else {
    document.getElementById(ids[5]).classList.add(propClass);
  }
