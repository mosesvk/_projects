                ...
                <div class="relative overflow-x-auto shadow-md">
                  <table class="w-full text-lg text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tfoot class="text-xs text-white uppercase backgroundGreen opacity-75">
                      ...
                      <th scope="col" class="px-4 py-2 text-lg tracking-wide border-2 border-white"></th>
                      <th scope="col" class="px-4 py-2 text-lg tracking-wide border-2 border-white"></th>
                      <th scope="col" class="px-4 py-2 text-lg tracking-wide border-2 border-white">                        <th scope="row" class="px-6 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white border-2 border-white"></th>
</th>
