...
const getTuitionDependencyChartOptions = (data) => {
  ...
  const tableHeaderRowPeer = document.getElementById("row_tuitionDependencyPeer_tableHeader");
  const ratioRowPeer = document.getElementById("row_tuitionDependencyPeer_ratio");
  const netTuitionAndFeesRowPeer = document.getElementById("row_tuitionDependencyPeer_netTuitionAndFees");
  const operatingRevenueRowPeer = document.getElementById("row_tuitionDependencyPeer_operatingRevenue");
...
const getTuitionDiscountRateChartOptions = (data) => {
  ...
  const tableHeaderRowClient = document.getElementById("row_tuitionDiscountRate_tableHeader");
  const ratioRowClient = document.getElementById("row_tuitionDiscountRate_ratio");
  const scholarshipsAndFinancialAidRowClient = document.getElementById("row_tuitionDiscountRate_scholarshipsAndFinancialAid");
  const tuitionAndFeesRowClient = document.getElementById("row_tuitionDiscountRate_tuitionAndFees");
  const tableHeaderRowPeer = document.getElementById("row_tuitionDiscountRatePeer_tableHeader");
  const ratioRowPeer = document.getElementById("row_tuitionDiscountRatePeer_ratio");
  const scholarshipsAndFinancialAidRowPeer = document.getElementById("row_tuitionDiscountRatePeer_scholarshipsAndFinancialAid");
  const tuitionAndFeesRowPeer = document.getElementById("row_tuitionDiscountRatePeer_tuitionAndFees");

  // Clear existing content before appending
  tableHeaderRowClient.innerHTML = `<th scope="col" class="px-2 py-1 text-lg tracking-wide">Client</th>`;
  ratioRowClient.innerHTML = `<th scope="row" class="px-6 py-2 text-xl text-gray-900 whitespace-nowrap dark:text-white">Tuition Dependency</th>`;
  scholarshipsAndFinancialAidRowClient.innerHTML = `<th scope="row" class="px-6 py-2 text-gray-900 whitespace-nowrap dark:text-white">Net Tuition and Fees</th>`;
  tuitionAndFeesRowClient.innerHTML = `<th scope="row" class="px-6 py-2 text-gray-900 whitespace-nowrap dark:text-white">Operating Revenue</th>`;
  tableHeaderRowPeer.innerHTML = `<th scope="col" class="px-2 py-1 text-lg tracking-wide">Peer</th>`;
  ratioRowPeer.innerHTML = `<th scope="row" class="px-6 py-2 text-xl text-gray-900 whitespace-nowrap dark:text-white">Tuition Dependency</th>`;
  scholarshipsAndFinancialAidRowPeer.innerHTML = `<th scope="row" class="px-6 py-2 text-gray-900 whitespace-nowrap dark:text-white">Net Tuition and Fees</th>`;
  tuitionAndFeesRowPeer.innerHTML = `<th scope="row" class="px-6 py-2 text-gray-900 whitespace-nowrap dark:text-white">Operating
  Revenue</th>`;
