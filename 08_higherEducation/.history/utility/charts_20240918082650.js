...
const getDebtBurdenRatioChartOptions = (data) => {
  ...
  selectedYearsArray.map((year) => {
    ...
    const debtServicePeerNum = getAverageOfArray(data.debtService_Peer[year])
    const operationalExpensePeerNum = getAverageOfArray(data.operationalExpense_Peer[year])
