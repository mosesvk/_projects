...
const getAdminCostsPerStudentChartOptions = (data) => {
  ...
  selectedYearsArray.map((year) => {
    ...
    array.map((item, idx) => {
      const salAdminAsst = data.salAdminAsst_Peer[year][idx];
      const ficaAdminAsst = data.ficaAdminAsst_Peer[year][idx];
      const healthAdminAsst = data.healthAdminAsst_Peer[year][idx];
      const disabilityAdminAsst = data.disabilityAdminAsst_Peer[year][idx];
      const retirementAdminAsst = data.retirementAdminAsst_Peer[year][idx];
      const housingAdminAsst = data.housingAdminAsst_Peer[year][idx];
      const otherAdminAsst = data.otherAdminAsst_Peer[year][idx];
      const totalStudentFTE = data.totalStudentFte_Peer[year][idx];
      const totalStudentUHC = data.totalStudentUhc_Peer[year][idx];
