...
const insertDataToAssetToLiabilityReport = (data, selectedYears) => {
  ...
  selectedYears.forEach(year => {
      ...
      const ratioPeer = Number(getSumOfArray(totalLiabilitiesPeer[year])) > 0 ?  styleNumber(Number(getSumOfArray(totalAssetsPeer[year])) / Number(getSumOfArray(totalLiabilitiesPeer[year])), 'dollar', 0) : '-'
