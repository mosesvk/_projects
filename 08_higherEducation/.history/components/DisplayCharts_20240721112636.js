...
const displayFinancialStatementComponent = () => {
  ...
  console.log(propertyAndEquipmentChart.ctx.series);
  // propertyAndEquipmentChart.ctx.exports.exportToSVG(propertyAndEquipmentChart.ctx);
  // propertyAndEquipmentChart.ctx.exports.exportToCSV({
  //     series: propertyAndEquipmentChart.ctx.series,
  //     columnDelimiter: ','
  // });
