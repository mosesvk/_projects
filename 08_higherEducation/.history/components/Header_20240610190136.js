...
const customSelectTrendlineElement = document.getElementById('custom-select-trendline');
...
const optionsListTrendlineElement = document.getElementById ('options-list-trendline');
