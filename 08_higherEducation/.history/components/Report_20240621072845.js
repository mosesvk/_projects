const displayReportComponent = () => {
  ...
  if (selectedYears) {
    ...
    insertDataToReport (
      cfiData,
      selectedYears,
      document.getElementById('row_primaryReserveRatio_tableHeader'),
      [
    ...
    insertCalculatedDataToReport (cfiData, selectedYears, document.getElementById('row_cfiRatio_calculated_tableHeader'),[
