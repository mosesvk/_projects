...
const displayFinancialAnalysisContentComponent = () => {
  ...
  const cashFlowsTrendChartElement = cashFlowsTrendChart.paper().svg()
...
const displayFinancialStatementComponent = () => {
  ...
  map_dataUri.set('totalLiabilities_Client', svgToBase64(liabilitiesChartElement))
  document.addEventListener("dark-mode", function () {
  ...
  map_dataUri.set('revenueAndSupport_Client', svgToBase64(revenueAndSupportChartElement))
  document.addEventListener("dark-mode", function () {
  ...
  const educationalProgramExpensesChartElement = educationalProgramExpensesChart.paper().svg()
  map_dataUri.set('educationalProgramExpenses_Client', svgToBase64(educationalProgramExpensesChartElement))
  document.addEventListener("dark-mode", function () {
