...
const displayFinancialStatementComponent = () => {
  const keys = [
    ...
    "netAssetsData",
    "totalExpensesData",
    "totalNonOperatingExpensesData",
    "totalChangesInNetAssetsData",
    "totalNaturalCategoryExpensesData",
    "cashFlowsOperatingActivitiesData",
    "cashFlowsInvestingActivitiesData",
    "cashFlowsFinancingActivitiesData",
