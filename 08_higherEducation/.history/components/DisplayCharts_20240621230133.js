...
const dropdownButton_returnOnNetAssets = document.getElementById('dropdown_returnOnNetAssets');
const detailsDiv_returnOnNetAssets = document.getElementById('details_returnOnNetAssets');
const arrowIcon_returnOnNetAssets = document.getElementById('arrow_returnOnNetAssets');

toggleDetails(dropdownButton_returnOnNetAssets, detailsDiv_returnOnNetAssets, arrowIcon_returnOnNetAssets);
...
const displayFinancialAnalysisContentComponent = () => {
  ...
  const fpaChart = new ApexCharts(document.querySelector("#fpaChart"), getFpaChartOptions (parseData.totalAssets_Client, parseData.totalLiabilities_Client, parseData.netPosition_Client));
