...
const displayFinancialAnalysisContentComponent = async () => {
  ...
  const FinancialPosition_chart = new ApexCharts(
  ...
  const assetToLiabilities_chart = new ApexCharts(
  ...
  const sourceOfIncomeClient_chart = new ApexCharts(
  ...
  document.addEventListener("dark-mode", function () {
    sourceOfIncomeClient_chart.updateOptions(getSoiClientChartOptions(parseData));
  });

  const sourceOfIncomePeer_chart = new ApexCharts(
    document.querySelector("#sourceOfIncomePeer_chart"),
    getSoiPeerChartOptions(parseData)
  );
  sourceOfIncomePeer_chart.render();
  document.addEventListener("dark-mode", function () {
    sourceOfIncomePeer_chart.updateOptions(getSoiPeerChartOptions(parseData));
  });

  const ffa_chart = new ApexCharts(
    document.querySelector("#ffa_chart"),
    getFfaChartOptions(parseData)
  );
  ffaChffa_chartart.render();
  document.addEventListener("dark-mode", function () {
    ffa_chart.updateOptions(getFfaChartOptions(parseData));
  });

  const cashFlowsTrend_chart = new ApexCharts(
...
const displayFinancialPositionComponent = () => {
  ...
  const currentRatio_chart = new ApexCharts(
