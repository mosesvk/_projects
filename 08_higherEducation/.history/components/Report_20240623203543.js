...
const insertDataToFfaReport = (data, selectedYears) => {
  ...
  document.getElementById ('ffa_revenueTuitionAndFees_Client').textContent = revenueTuitionAndFeesClient > 0
  ...
  document.getElementById ('ffa_revenueScholarshipsAndFinancialAid_Client').textContent = revenueSchoolServicesClient > 0
  ...
  document.getElementById ('ffa_unrestrictedGifts_Client').textContent = totalRevenueContributionsClient > 0
