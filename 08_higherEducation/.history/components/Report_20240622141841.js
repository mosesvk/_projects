...
const insertDataToAssetToLiabilityReport = (data, selectedYears) => {
  ...
  selectedYears.forEach(year => {
      ...
      const totalAssetsPeerValue = styleNumber(getSumOfArray(totalAssetsPeer[year]), 'dollar', 0)
      const totalLiabilitiesPeerValue = styleNumber(getSumOfArray(totalLiabilitiesPeer[year]), 'dollar', 0)
      const ratioPeer = totalAssetsPeerValue / totalLiabilitiesPeerValue
      const totalAssetToLiabilitysPeerValue = styleNumber(ratioPeer, 'dollar', 0)
