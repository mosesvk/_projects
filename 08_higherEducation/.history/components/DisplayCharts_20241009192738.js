...
const displayFinancialAnalysisContentComponent = async () => {
  ...
  FinancialPosition_chart = new ApexCharts(
    ...
    getFinancialPositionChartOptions(parseData)
  );
...
const displayDebtAndEndowmentComponent = () => {
  ...
  // endowmentOperatingBudgetChart
  const endowmentOperatingBudget_chart = new ApexCharts(
    document.querySelector("#endowmentOperatingBudget_chart"),
    getEndowmentOperatingBudgetChartOptions(
      parsedData["endowmentOperatingBudgetData"]
    )
  );
  endowmentOperatingBudget_chart.render();
  document.addEventListener("dark-mode", function () {
    endowmentOperatingBudget_chart.updateOptions(
      getEndowmentOperatingBudgetChartOptions(
        parsedData["endowmentOperatingBudgetData"]
      )
    );
