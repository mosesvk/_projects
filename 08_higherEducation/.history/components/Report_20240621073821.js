const displayReportComponent = () => {
  ...
  if (selectedYears) {
    insertDataToReport (cfiData, selectedYears, document.getElementById('primaryReserveRatio_clientTable'), [
      ['cfiRatio', 'num', 1],
...
const addTotalDataToEveryRow = (data, selectedYears, arrayOfNames, table) => {
  ...
  // find tables first child with an id that ends with _tableHeader
  const tableHeaderRow = table.querySelector ('tr[id$="_tableHeader"]');
...
const addYearColumnsToReportTable = (years, tableHeaderRow) => {
