...
const insertDataToFfaReport = (data, selectedYears) => {
  ...
  const revenueSchoolServicesClient = Number (
    data['ffa_scholarshipsFinancial'][currentYear].value
  );
  document.getElementById ('ffa_revenueScholarshipsAndFinancialAid').textContent = revenueSchoolServicesClient > 0
