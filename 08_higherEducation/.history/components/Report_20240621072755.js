const displayReportComponent = () => {
  ...
  if (selectedYears) {
    ...
    insertDataToReport (cfiData, selectedYears, document.getElementById('row_cfiRatio_tableHeader'), [
      ['cfiRatio', 'num', 1],
    ...
    insertDataToReport (
      cfiData,
      selectedYears,
      document.getElementById('row_cfiRatio_calculated_tableHeader'),
      [
    ...
    insertCalculatedDataToReport (cfiData, selectedYears, document.getElementById('row_primaryReserveRatio_tableHeader'),[
...
const addTotalDataToEveryRow = (data, selectedYears, arrayOfNames, tableHeaderRow) => {
