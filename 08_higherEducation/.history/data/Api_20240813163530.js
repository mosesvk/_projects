...
const processRevenueExpenseContentData = (
  ...
  const dataKeys = ["salariesAndBenefitsToTotalExpenseData", "averageEmployeeSalaryData", "salariesAndBenefitsPerNetTuitionData"];
  const dataObjects = [salariesAndBenefitsToTotalExpense_obj, averageEmployeeSalary_obj, salariesAndBenefitsPerNetTuition_obj];
