...
const processCfiData = (years, recordsPeer, recordsClient) => {
  ...
  years.forEach (year => {
    ...
    filteredClientRecords.forEach (record => {
      ...
      // cfi_primaryReserveAdjustment_Client
      insertDataIntoObject (
        'client',
        year,
        object,
  ...
  const cfiValue = object.cfiRatio_Client[selectedYears[selectedYears.length - 1]].value;
};
