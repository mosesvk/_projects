...
const processFinancialStatementContentData = (recordsPeer, recordsClient) => {
  ...
  years.forEach((year) => {
    ...
    filteredClientRecords.forEach((record) => {
      ...
      const nonOperatingActivities_array = [
        ...
        {
          key: "totalNonOperatingActivities_Client",
      ...
      const changesInNetAssetsWithDR_array = [
        ...
        {
          key: "totalChangeInNetAssets_Client",
      ...
      const naturalExpenseCategories_array = [
        ...
        {
          key: "totalNaturalExpenseCategories_Client",
      ...
      const cashFlowsOperating_array = [
        ...
        {
          key: "totalNaturalCategoryExpenses_Client",
          field: "r166_ctotal_natural_category_expenses",
        },
      ];
      ...
      const cashFlowsFinancing_array = [
        ...
        {
          key: "netCashFinancingActivities_Client",
      ...
      const propertyAndEquipment_array = [
        ...
        {
          key: "totalPElessDepreciation_Client",
  ...
  localStorage.removeItem("totalAssetsData");
  localStorage.removeItem("totalLiabilitiesData");
  localStorage.removeItem("netAssetsData");
  localStorage.removeItem("revenueAndSupportData");
  localStorage.removeItem("educationalProgramData");
  localStorage.removeItem("nonOperatingActivitiesData");
  localStorage.removeItem("changesInNetAssetsWithDRData");
  localStorage.removeItem("naturalExpenseCategoriesData");
  localStorage.removeItem("cashFlowsOperatingData");
  localStorage.removeItem("cashFlowsInvestingData");
  localStorage.removeItem("cashFlowsFinancingData");
  localStorage.removeItem("propertyAndEquipmentData");
  

  localStorage.setItem("totalAssetsData", JSON.stringify(totalAssets_obj));
  localStorage.setItem(
    "totalLiabilitiesData",
    JSON.stringify(totalLiabilities_obj)
  );
  localStorage.setItem("netAssetsData", JSON.stringify(netAssets_obj));
  localStorage.setItem(
    "revenueAndSupportData",
    JSON.stringify(revenueAndSupport_obj)
  );
  localStorage.setItem(
    "educationalProgramData",
    JSON.stringify(educationalProgram_obj)
  );
  localStorage.setItem(
    "nonOperatingActivitiesData",
    JSON.stringify(nonOperatingActivities_obj)
  );
  localStorage.setItem(
    "changesInNetAssetsWithDRData",
    JSON.stringify(changesInNetAssetsWithDR_obj)
  );
  localStorage.setItem(
    "naturalExpenseCategoriesData",
    JSON.stringify(naturalExpenseCategories_obj)
  );
  localStorage.setItem(
    "cashFlowsOperatingData",
    JSON.stringify(cashFlowsOperating_obj)
  );
  localStorage.setItem(
    "cashFlowsInvestingData",
    JSON.stringify(cashFlowsInvesting_obj)
  );
  localStorage.setItem(
    "cashFlowsFinancingData",
    JSON.stringify(cashFlowsFinancing_obj)
  );
  localStorage.setItem(
    "propertyAndEquipmentData",
    JSON.stringify(propertyAndEquipment_obj)
  );
};
