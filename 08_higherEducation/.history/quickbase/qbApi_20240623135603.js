...
const processFinancialAnalysisContentData = (years, recordsPeer, recordsClient) => {
  ...
  years.forEach (year => {
    ...
    filteredClientRecords.forEach (record => {
      ...
      // ffa_revenueContributions_Client
      insertDataIntoObject (
        'client',
        year,
        object,
...
const getRecordsForPeer = async (years, dataStr) => {
  ...
  const apiCallPeerData = {
    ...
    {7.EX.${currentYear}}
    `,
    clist: '7.536.619.537.618.534.539.541.549.551.547.553.390.392.396.393.395.600.606.390.392.396.393.395.390.391.549.392.395.393.394.411.450.451.452.453.454.455.727',
  };
