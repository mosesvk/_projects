...
class ApiService {
  ...
  getClientQuery(selectedClientsSet) {
    ...
    // For large numbers of clients (more than 20), use a more generalized approach
    if (selectedClients.length > 20) {
      console.log(`Large client set (${selectedClients.length}), using simplified query`);
      // This will match any record with a client name (field 59) that exists
      return '({59.XEX.""})';
    }
    
    // For small numbers of clients, use the specific approach with OR conditions
