...
async function apexChartsExportPrint() {
  ...
  try {
    ...
    uploadXml += createFieldXml(6, uniqueClients?.size || 0);
    const selectedYears = getSelectedYearsFromLocalStorage()
    uploadXml += createFieldXml(23, selectedYears[0] || 0);
    uploadXml += createFieldXml(24, selectedYears[selectedYears.length - 1] || 25000);
