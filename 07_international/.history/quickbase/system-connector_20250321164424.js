...
class SystemConnector {
  ...
  displayCharts() {
    ...
    if (window.displayComponents && typeof displayComponents.displayAllComponents === 'function') {
      ...
      // Explicitly call report component update
      if (typeof displayReportComponent === 'function') {
        console.log("Updating report component after chart display");
        setTimeout(displayReportComponent, 100); // Small delay to ensure charts are rendered first
      }
    } 
    // Then try the individual display functions
      ...
      if (typeof displayReportComponent === 'function') {
        console.log("Updating report component after individual component displays");
        setTimeout(displayReportComponent, 100);
      }
    } else {
