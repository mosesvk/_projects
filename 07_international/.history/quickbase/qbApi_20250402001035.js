...
class ApiService {
  ...
  async getRecordsForPeer(years, dataStr = "<qdbapi>") {
    ...
    const apiCallPeerData = {
      act: "API_DoQuery",
      query: `{301.EX.${currentYear}} AND (${clientQuery})
      `,
      clist:
    ...
    try {
      ...
      console.log(`Found ${recordsForPeer.length} peer records for year ${currentYear}`);
      ...
      try {
        ...
        console.error("Error parsing XML after fetch error:", parseError);
        return [];
      }
    }
  }
