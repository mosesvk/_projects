...
class AppController {
  ...
  initializeEventListeners() {
    ...
    // Attach run button event listener
  ...
  displayAllComponents() {
    // Use the chart system's displayAllComponents method
    displayComponents.displayAllComponents();
    
    // Dispatch event to trigger chart reference update
    document.dispatchEvent(new Event('chartsRendered'));
  }
}

// Export the API Controller for global use
window.appController = new AppController();
 Expense Percent Program
        this.dataStore.insertData(
          "expense",
          "peer",
          year,
