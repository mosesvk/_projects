...
window.processApiData = function(selectedYears, recordsPeer, recordsClient) {
  ...
  if (typeof processApiCalls === 'function') {
    const processedData = processApiCalls(selectedYears, recordsPeer, recordsClient);
    ...
    setTimeout(() => {
      if (typeof enhancedInitializeChartDisplay === 'function') {
        console.log('Triggering enhancedInitializeChartDisplay from processApiData');
      ...
      else if (window.systemConnector && typeof window.systemConnector.displayCharts === 'function') {
        console.log('Triggering systemConnector.displayCharts from processApiData');
