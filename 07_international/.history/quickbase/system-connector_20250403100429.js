  ...
  patchMissingFunctions() {
    ...
    if (typeof window.processApiData !== "function") {
      ...
      window.processApiData = function(selectedYears, recordsPeer, recordsClient) {
        ...
        if (typeof window.processApiCalls === "function") {
          return window.processApiCalls(selectedYears, recordsPeer, recordsClient);
        } else {
          console.warn("processApiCalls function not found, using direct processor");
    ...
    if (typeof window.initializeChartDisplay !== "function") {
      ...
      window.initializeChartDisplay = function() {
        ...
        if (window.displayComponents && typeof window.displayComponents.displayAllComponents === "function") {
