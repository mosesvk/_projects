...
class ChartManager {
    ...
    createChartFromParsedData(
      ...
      this.updateModal(mainName, parsedData[peerDataKey], parsedData[clientDataKey], parsedData);
    ...
    _createCashFlowDataRow(mainName, year, operatingValue, investingValue, financingValue, totalValue) {
      ...
      cells.forEach(cell => {
        ...
        td.scope = "row";
        td.textContent = cell.format ? styleNumber(cell.value, cell.format) : cell.value;
        row.appendChild(td);
      });
