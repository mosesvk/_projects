...
class ChartManager {
  ...
  _addPeerDataToModalRow(
    ...
    const formattedAvg =
      typeof styleNumber === "function" && avgValue !== undefined
        ? styleNumber(avgValue, dataType, fixedNum)
        : avgValue !== undefined
        ? avgValue.toFixed(fixedNum || 2)
        : "-";

    const formattedP25 =
      typeof styleNumber === "function" && p25Value !== undefined
        ? styleNumber(p25Value, dataType, fixedNum)
        : p25Value !== undefined
        ? p25Value.toFixed(fixedNum || 2)
        : "-";

    const formattedMid =
      typeof styleNumber === "function" && midValue !== undefined
        ? styleNumber(midValue, dataType, fixedNum)
        : midValue !== undefined
        ? midValue.toFixed(fixedNum || 2)
        : "-";

    const formattedP75 =
      typeof styleNumber === "function" && p75Value !== undefined
        ? styleNumber(p75Value, dataType, fixedNum)
        : p75Value !== undefined
        ? p75Value.toFixed(fixedNum || 2)
        : "-";
