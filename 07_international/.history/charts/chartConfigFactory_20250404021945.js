...
class ChartConfigFactory {
  ...
  createMainChartConfig({
    ...
    const clientArray = chartData.clientArray;
    const peerAvg = chartData.peerAvg;
    const peerMid = chartData.peerMid;
    const peer25 = chartData.peer25;
    const peer75 = chartData.peer75;
