...
const addPeerDataToRow = (
  ...
  const mid = peer ? parseFloat(getMidpointOfArray(peer[dataArray]), 'liquidityFundsAvailable') : "";
  // console.log('mid', mid);
  ...
  if (name == 'liquidityFundsAvailable') console.log('liquidityFundsAvailable', {textAvg, testAvg,  mid, textMid, min, textMin, max, textMax, peerArray: peer[dataArray], type, fixedNum})
