...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.addEventListener("filtersChanged", function () {
    ...
    console.log("Current filter values:", {
      givingMin:
        window.sliderValue !== undefined ? window.sliderValue : "undefined",
      givingMax:
        window.sliderValue2 !== undefined ? window.sliderValue2 : "undefined",
      missionMin:
        window.missionValue !== undefined ? window.missionValue : "undefined",
      missionMax:
        window.missionValue2 !== undefined ? window.missionValue2 : "undefined",
      selectedRegions: window.selectedRegions_Array
        ? Array.from(window.selectedRegions_Array)
        : "undefined",
      selectedTypes: window.selectedTypes_Array
        ? Array.from(window.selectedTypes_Array)
        : "undefined",
      selectedClients: window.selectedClients_Array
