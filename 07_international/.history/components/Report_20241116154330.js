...
const addPeerDataToRow = (
  ...
  if (name == 'liquidityFundsAvailable') console.log('percentWithoutDR_excludingPPE', {textAvg, mid, textMid, min, textMin, max, textMax, peerArray: peer[dataArray], type, fixedNum})
