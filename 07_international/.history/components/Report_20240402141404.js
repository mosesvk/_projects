const displayReportComponent = () => {
  ...
  if (selectedYears) {
    ...
    insertDataToReport(expenseData, selectedYears, [
      ['functionalExpensePercent_program', 'percent', 0],
      ['functionalExpensePercent_administrative', 'percent', 0],
      ['functionalExpensePercent_fundraising', 'percent', 0],
      ['functionalExpensePercent_other', 'percent', 0],
      ['costOfContributions', 'dollar', 0],
      ['expensesPerGivingUnit', 'dollar', 0],
      ['expensesPerMissionaryUnit', 'dollar', 0],
      ['expensesPerFullTimeEquivalent', 'dollar', 0],
      ['salariesAndBenefitsAsPercentOfTotalExpenses', 'percent', 0],
      ['salariesAndBenefitsPerFTES', 'dollar', 0],
    ])
