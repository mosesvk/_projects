...
const getNetAssetBreakdownOptions = (
  ...
  selectedYearsArray.forEach((year) => {
    if (
      parsedData[
        "_01__03na___01_net_assets_without_donor_restrictions_Client"
      ] &&
      parsedData["_01__03na___01_net_assets_without_donor_restrictions_Client"][
        year
      ] &&
      parsedData["_01__03na___01_net_assets_without_donor_restrictions_Client"][
        year
  ...
  selectedYearsArray.forEach((year) => {
    if (
      parsedData[
        "_01__03na___03a_net_assets_with_donor_restrictions_sum_Client"
      ] &&
      parsedData[
        "_01__03na___03a_net_assets_with_donor_restrictions_sum_Client"
      ][year] &&
  ...
  return {
    ...
    dataLabels: {
      ...
      formatter: function (val, opt) {
        ...
        const percentage =
          opt.seriesIndex === 0
            ? netAssetsWithoutDRPercentage[opt.dataPointIndex]
            : netAssetsWithDRPercentage[opt.dataPointIndex];

        return formatLargeNumber(val) + ` (${percentage}%)`;
      },
      style: {
        fontSize: "12px",
        colors: ["#fff"],
