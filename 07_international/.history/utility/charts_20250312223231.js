...
const getCostOfContributionsDetailViewOptions = (
  ...
  const maxRatioValue = Math.ceil(Math.max(...allRatioValues) * 1.4); // 30% padding above max
  ...
  const maxDollarValue = Math.ceil(Math.max(...allDollarValues) * 1.4); // 30% padding above max
