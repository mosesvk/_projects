...
function getPeerAndClientChartDataArrays(
  ...
  years.forEach((year) => {
    ...
    if (parsedData[dataPeer] && parsedData[dataClient]) {
      ...
      peerAvg.push(styleNumber(avg));
      peerMid.push(styleNumber(mid));
      peer25.push(styleNumber(lower25));
      peer75.push(styleNumber(higher75));
      clientArray.push(styleNumber(clientNum));
    }
