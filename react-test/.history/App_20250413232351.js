      ...
      <div className="max-w-4xl mx-auto mt-8">
        ...
        <div className="bg-white shadow rounded-lg p-6 mb-8">
          ...
          <div className="mt-4 p-4 bg-yellow-50 border border-yellow-100 rounded-md">
            ...
            <p className="text-yellow-700 mb-2">
              This demo uses <strong>simulated data</strong> because browsers cannot directly access 
              the Quickbase API due to CORS restrictions.
            </p>
            <p className="text-yellow-700 mb-2">
              In a production environment, you would need a backend server to proxy API requests 
              to Quickbase.
            </p>
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <ol className="list-decimal pl-5 space-y-2 text-gray-700">
            <li>Create a backend proxy server to handle actual Quickbase API requests</li>
            <li>Replace the mock data with real data once the proxy is in place</li>
            <li>Add data visualization using ApexCharts</li>
            <li>Implement data filtering and manipulation features</li>
          </ol>
        </div>
      </div>
    );
