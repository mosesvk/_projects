...
const getChartInstance = (chartId) => {
  ...
  const chartMap = {
    ...
    mandatoryDebtServiceToContributionsWithout_chart: window.mandatoryDebtServiceToContributionsWithout_chart,
    ...
    benefitsToSalaries_chart: window.benefitsToSalaries_chart,
    salariesBenefitsIncludingOutsourcedEmployees_chart: window.salariesBenefitsIncludingOutsourcedEmployees_chart,
    personnelToCashExpenditure_chart: window.personnelToCashExpenditure_chart,
