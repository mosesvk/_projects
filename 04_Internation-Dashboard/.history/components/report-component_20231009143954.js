        ...
        <div class="overflow-x-auto rounded-lg">
          <div class="inline-block min-w-full align-middle">
            ...
            >
              ...
              >
                <thead
                  class="text-xs text-gray-700 uppercase bg-green-200 dark:bg-gray-700 dark:text-gray-400"
                >
                  <tr id="row_tableHeader">
                    <th scope="col" class="px-6 py-3 text-lg">Enrollment Comparison between Years</th>
                    <th scope="col" class="px-6 py-3">2020</th>
                    <th scope="col" class="px-6 py-3">2021</th>
                    <th scope="col" class="px-6 py-3">2022</th>
