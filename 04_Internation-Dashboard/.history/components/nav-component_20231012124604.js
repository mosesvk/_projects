...
`     <div class='px-3 py-3 lg:px-5 lg:pl-3'>
      <div class='flex items-center justify-between'>
        ...
        <div class='flex cursor-pointer'>
          <div
            id='custom-select'
            class='block py-2.5 px-0 w-full text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 hover:border-gray-400 hover:text-gray-600 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer relative text-xl'
          >
            <div class='flex items-center justify-between'>
              <svg
