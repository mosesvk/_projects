...
console.log("Loaded QB_USER_TOKEN:", process.env.QB_USER_TOKEN ? 'Exists' : 'MISSING');
console.log("Loaded QB_APP_ID:", process.env.QB_APP_ID ? 'Exists' : 'MISSING');
console.log("Loaded QB_TABLEID_INT_CLIENT:", process.env.QB_TABLEID_INT_CLIENT ? 'Exists' : 'MISSING');
